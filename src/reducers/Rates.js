...
export default function() {
    return [
        ...
        {name: 'mm', options: [
            {name: 'mm', f: (i) => { return (i*1).toFixed(2)}}, {name: 'cm', f: (i) => {return (i/1000).toFixed(2)}}, {name: 'm', f:(i) => {return (i/28.3495).toFixed(2)}}, {name: 'inch', f:(i) => {return (i/453.592).toFixed(2)}}, {name: 'feet', f:(i) => {return (i/6350.29).toFixed(2)}}, {name: 'mile', f:(i) => {return (i/907185).toFixed(2)}}
        ]},
        {name: 'cm', options: [
